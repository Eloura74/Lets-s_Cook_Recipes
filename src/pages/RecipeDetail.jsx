...
const RecipeDetail = () => {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-[#DCD7C9]">
            Recette non trouvée
          </h2>
  ...
  const filteredInstructions = recipe.instructions.filter(instruction => instruction && instruction.trim() !== '')

  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto bg-[#2C3639]/95 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden">
        {recipe.imageUrl && (
